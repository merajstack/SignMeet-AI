...
export const Auth: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-[#f8f9ff] text-[#121c2a] transition-colors overflow-hidden">
      {/* Left Panel: Hero / Testimonial / Purpose */}
      <div className="w-full md:w-1/2 min-h-[450px] md:min-h-screen p-8 md:p-16 flex flex-col justify-between bg-gradient-to-br from-[#eff4ff] via-[#f8f9ff] to-[#e6eeff] border-b md:border-b-0 md:border-r border-[#c3c6d6]/20 relative">
        ...
        <div className="relative z-10 my-auto py-10 max-w-xl">
          <h2 className="text-3xl md:text-4xl lg:text-[42px] font-extrabold text-[#121c2a] leading-[1.25] tracking-tight mb-8">
            "Breaking communication barriers with AI, not interpreters."
          </h2>
      ...
      <div className="w-full md:w-1/2 min-h-[550px] md:min-h-screen p-8 md:p-16 lg:p-24 flex flex-col justify-between bg-white transition-colors relative">
        ...
        <div className="w-full max-w-md mx-auto my-auto py-8 flex flex-col items-start text-left">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3.5 bg-[#0040a1] hover:bg-[#0056d2] text-white py-4 px-6 rounded-xl font-bold text-base shadow-lg shadow-[#0040a1]/25 hover:shadow-xl transition-all active:scale-[0.99] disabled:opacity-60 cursor-pointer group mb-8"
          >
            {loading ? (
